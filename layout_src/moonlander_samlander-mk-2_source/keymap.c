...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    OSL(3),         KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TD(DANCE_0),                                    LALT(LGUI(LCTL(LSFT(KC_M)))),KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       
    KC_LPRN,        KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           LALT(LGUI(LCTL(LSFT(KC_V)))),                                KC_MEH,         KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,        
    KC_LCBR,        TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    KC_G,           LALT(LGUI(LCTL(LSFT(KC_P)))),                                                                KC_HYPR,        KC_H,           TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   KC_QUOTE,       
    KC_LBRC,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_EQUAL,       
    TD(DANCE_5),    LSFT(RCTL(KC_M)),KC_MAC_PASTE,   KC_MAC_COPY,    KC_GRAVE,       TD(DANCE_6),                                                                                                    KC_RIGHT_GUI,   TD(DANCE_11),   TD(DANCE_12),   KC_LBRC,        KC_RBRC,        TG(1),          
    MT(MOD_LSFT, KC_SPACE),KC_BSPC,        MT(MOD_LGUI, KC_ESCAPE),                KC_RIGHT_SHIFT, MT(MOD_RCTL, KC_TAB),MT(MOD_LALT, KC_ENTER)
  ),
  [1] = LAYOUT_moonlander(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
    KC_RPRN,        KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_PIPE,        KC_TRANSPARENT,                                 RGB_SPI,        KC_UP,          KC_7,           KC_8,           KC_9,           KC_ASTR,        KC_F12,         
    KC_RCBR,        KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_TRANSPARENT,                                                                 RGB_SPD,        KC_DOWN,        KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     LGUI(LSFT(KC_Z)),
    KC_RBRC,        KC_PERC,        KC_CIRC,        KC_LBRC,        KC_RBRC,        KC_TILD,                                        KC_AMPR,        KC_1,           KC_2,           KC_3,           KC_BSLS,        KC_MAC_UNDO,    
    LGUI(KC_X),     LGUI(LSFT(KC_V)),HSV_0_255_255,  HSV_86_255_128, HSV_172_255_255,RGB_MODE_FORWARD,                                                                                                RGB_TOG,        KC_TRANSPARENT, KC_DOT,         KC_0,           KC_EQUAL,       KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_RPRN,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_RCBR,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_13),                                                                   KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_AUDIO_VOL_UP,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MAC_CUT,     LGUI(LSFT(KC_V)),KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_RIGHT_GUI,   KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_STOP,  KC_AUDIO_VOL_UP,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TAB,                         LALT(LGUI(LCTL(LSFT(KC_A)))),KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_W,           KC_F,           KC_P,           KC_B,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_J,           KC_L,           KC_U,           KC_Y,           KC_SCLN,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_A,           KC_R,           KC_S,           KC_T,           KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           KC_N,           KC_E,           KC_I,           KC_O,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    TD(DANCE_14),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [4] = { {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255}, {219,249,255} },
...
void on_dance_0(tap_dance_state_t *state, void *user_data) {
    if(state->count == 3) {
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_L)))));
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_L)))));
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_L)))));
    }
    if(state->count > 3) {
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        case SINGLE_TAP: register_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); break;
        case SINGLE_HOLD: register_code16(KC_LEFT_CTRL); break;
        case DOUBLE_TAP: register_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); register_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); register_code16(LALT(LCTL(LGUI(LSFT(KC_L)))));
    }
}
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[0].step) {
        case SINGLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); break;
        case SINGLE_HOLD: unregister_code16(KC_LEFT_CTRL); break;
        case DOUBLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_L))))); break;
    }
...
void on_dance_5(tap_dance_state_t *state, void *user_data) {
    if(state->count == 3) {
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_F)))));
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_F)))));
        tap_code16(LALT(LCTL(LGUI(LSFT(KC_F)))));
    }
    if(state->count > 3) {
...
void dance_5_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        case SINGLE_TAP: register_code16(LALT(LCTL(LGUI(LSFT(KC_F))))); break;
        case DOUBLE_TAP: layer_move(4); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(LCTL(LGUI(LSFT(KC_F))))); register_code16(LALT(LCTL(LGUI(LSFT(KC_F)))));
    }
}
...
void dance_5_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[5].step) {
        case SINGLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_F))))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_F))))); break;
    }
...
void dance_13_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[13].step) {
        ...
        case DOUBLE_TAP: register_code16(LGUI(LSFT(KC_TAB))); break;
...
void dance_13_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[13].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LGUI(LSFT(KC_TAB))); break;
